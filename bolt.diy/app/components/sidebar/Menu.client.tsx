...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-bolt-elements-textSecondary border-b border-bolt-elements-borderColor/60 bg-black">
...
export const Menu = () => {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--bolt-menu-offset', open ? `${MENU_WIDTH}px` : '0px');

    return () => {
      document.documentElement.style.setProperty('--bolt-menu-offset', '0px');
    };
  }, [open]);
    ...
    <>
      <motion.div
        ...
        className={classNames(
          ...
          'bg-black border-r border-bolt-elements-borderColor',
          'shadow-[0_25px_70px_rgba(4,7,15,0.65)] text-sm text-bolt-elements-textSecondary',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-bolt-elements-borderColor/60 bg-black rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-center w-[32px] h-[32px] overflow-hidden bg-bolt-elements-bg-depth-2 border border-bolt-elements-borderColor text-bolt-elements-textSecondary rounded-full shrink-0">
              {profile?.avatar ? (
                <img
                  src={profile.avatar}
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
            ...
            <DialogRoot open={dialogContent !== null}>
              {binDates(filteredList).map(({ category, items }) => (
                <div key={category} className="mt-2 first:mt-0 space-y-1">
                  <div className="text-[11px] font-medium text-bolt-elements-textTertiary sticky top-0 z-1 bg-black px-4 py-1 tracking-[0.08em]">
                    {category}
                  </div>
              ...
              <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                {dialogContent?.type === 'delete' && (
                  <>
                    ...
                    <div className="flex justify-end gap-3 px-6 py-4 bg-black border-t border-bolt-elements-borderColor/60">
                  ...
                  <>
                    <div className="p-6 bg-black">
                      ...
                      <DialogDescription className="mt-2 text-bolt-elements-textSecondary">
                        ...
                        <div className="mt-2 max-h-32 overflow-auto border border-bolt-elements-borderColor rounded-md bg-[#080c16] p-2">
          ...
          <div className="flex items-center justify-between border-t border-bolt-elements-borderColor px-4 py-3 bg-black">
