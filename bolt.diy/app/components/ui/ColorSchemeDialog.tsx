          ...
          return (
            <div key={f.key} className="feature-card-container p-2">
              <button
                type="button"
                onClick={() => handleFeatureToggle(f.key)}
                className={`group relative w-full p-6 text-sm font-medium transition-all duration-200 bg-bolt-elements-bg-depth-3 text-bolt-elements-item-textSecondary ${
                  f.key === 'rounded'
                    ? isSelected
                      ? 'rounded-3xl'
                      : 'rounded-xl'
            ...
            <div className="flex gap-2 items-center">
              ...
              {['light', 'dark', 'neon'].map((t) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-md border transition-all duration-150 ${
                    localTheme === t ? 'bg-bolt-elements-item-backgroundAccent text-bolt-elements-item-contentAccent' : 'bg-bolt-elements-bg-depth-1 text-bolt-elements-textSecondary'
                  }`}
                >
