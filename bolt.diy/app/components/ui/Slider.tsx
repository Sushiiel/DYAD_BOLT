...
export const Slider = genericMemo(<T,>({ selected, options, setSelected }: SliderProps<T>) => {
  ...
  return (
    <div className="flex items-center flex-wrap shrink-0 gap-1 bg-transparent border-2 border-white overflow-hidden rounded-none p-1">
  ...
  return (
    <button
      ...
      className={classNames(
        'text-xs font-black uppercase tracking-wider px-4 py-1.5 relative transition-all',
        selected
          ? 'bg-white text-black'
