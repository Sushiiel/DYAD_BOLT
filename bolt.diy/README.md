...
- **Deploy** directly to **Netlify** or **Cloudflare Pages**
...
3. **Push to main**: The deployment workflow will automatically trigger and deploy your application to Cloudflare Pages.
